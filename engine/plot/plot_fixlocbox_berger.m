function plot_fixlocbox_berger(min_list, max_list, deltat, tlist, color)

    m = size(tlist);
    m = m(2);
    figure;
    title('Bloated Discrete Reachable Sets at x = 5')
    xlabel('Time t')
%     ylabel('\boldsymbol{u}_4^n')
    ...
    rectangle('Position',[7   0.5  1  0.3], 'FaceColor',[1 0 0], 'EdgeColor',[1 0 0]);  %safety specification    
%     xlim([-0.5 5.5])
%     ylim([0 1.2])
end