function sol = solve_ASCN5(deltat, deltax, alpha, init, time, xlist, tlist, lambda)
...
%-------------------------1st thread-------------------------- 
            ...
            temp{4} = u(5*l+1:7*l, 1);
            temp{5} = u(7*l+1:9*l, 1);
...
%-------------------------5rd thread--------------------------
            ...
            u(5*l+1:7*l, 1) = temp{4}; 
            u(7*l+1:9*l, 1) = temp{5};             

            
            update{1} = u(1:2*l, 1);            
            update{2} = u(2*l+1:4*l, 1);       
            update{3} = u(4*l+1:6*l, 1);       
            update{4} = u(6*l+1:8*l, 1);   
            update{5} = u(8*l+1:9*l, 1);  
...
%-------------------------3rd thread--------------------------
            ...
            u(4*l+1:6*l, 1) = update{3};   
            u(6*l+1:8*l, 1) = update{4};               
            u(8*l+1:9*l, 1) = update{5};
            ...
            temp{3} = u(4*l+1:6*l, 1);
            temp{4} = u(6*l+1:8*l, 1);
            temp{5} = u(8*l+1 : 9*l, 1);
...
%-------------------------5rd thread--------------------------
            ...
            u(4*l+1:6*l, 1) = temp{3};         
            u(6*l+1:8*l, 1) = temp{4};    
            u(8*l+1 : 9*l, 1) = temp{5};            

            
            update{1} = u(1:l, 1);            
            update{2} = u(l+1:3*l, 1);         
            update{3} = u(3*l+1:5*l, 1);         
            update{4} = u(5*l+1:7*l, 1);   
            update{5} = u(7*l+1:9*l, 1);
...
%-------------------------5rd thread--------------------------
            ...
            u(5*l+1 : 7*l, 1) = update{3};
            u(7*l+1 : 9*l, 1) = update{3};            
