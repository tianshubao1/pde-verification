...
%     init_min1 = zeros(1, numofmesh) + 5;
%     init_min1(1, 1: numofmesh/2) = 4;          
%     init_max1 = zeros(1, numofmesh) + 8;
%     init_max1(1, 1: numofmesh/2 ) = 10;
% 
%     init_min2 = zeros(1, numofmesh) ;
%     init_min2(1, 1: numofmesh/2) = 4;         
%     init_max2 = zeros(1, numofmesh) +3;
%     init_max2(1, 1: numofmesh/2 ) = 6;
% 
%     init_min3 = zeros(1, numofmesh) ;
%     init_min3(1, 1: numofmesh/2) = 3;          
%     init_max3 = zeros(1, numofmesh) + 3;
%     init_max3(1, 1: numofmesh/2 ) = 5;
    ...
    tic;
    [sol_min, sol_max] = reach_sys_nonlnhypo_global(gamma, deltat, deltax, init_min, init_max, time, xlist, tlist, h_min', h_max');
    toc;
...
%     h_max1 = h_coef_max*exp(-xgrid-tgrid) - (slope_t_max + slope_x_max)';
    ...
    [err_sol_min, err_sol_max] = reach_sys_nonlnhypo_global(gamma, deltat, deltax, init_min, init_max, time, xlist, tlist, h_min', h_max');
